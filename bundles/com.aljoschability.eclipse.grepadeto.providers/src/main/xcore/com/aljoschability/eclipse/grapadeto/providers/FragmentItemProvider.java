    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Fragment_pattern_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Fragment_pattern_feature", "_UI_Fragment_type"),
         GrapadetoPackage.Literals.FRAGMENT__PATTERN,
         true,
         false,
         true,
         null,
  ...
  protected void addPatternsPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Fragment_patterns_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Fragment_patterns_feature", "_UI_Fragment_type"),
         GrapadetoPackage.Literals.FRAGMENT__PATTERNS,
         true,
         false,
         true,
         null,
  ...
  protected void addObjectsPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Fragment_objects_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Fragment_objects_feature", "_UI_Fragment_type"),
         GrapadetoPackage.Literals.FRAGMENT__OBJECTS,
         true,
         false,
         true,
         null,
  ...
  protected void addModifierPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Fragment_modifier_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Fragment_modifier_feature", "_UI_Fragment_type"),
         GrapadetoPackage.Literals.FRAGMENT__MODIFIER,
         true,
         false,
         false,
