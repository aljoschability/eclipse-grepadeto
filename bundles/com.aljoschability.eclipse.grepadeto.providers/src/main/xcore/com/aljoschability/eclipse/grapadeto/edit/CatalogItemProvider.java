...
/**
 * This is the item provider adapter for a {@link com.aljoschability.eclipse.grapadeto.Catalog} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CatalogItemProvider extends CommentableItemProvider {
	/**
	...
	protected void addModelIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_Catalog_modelId_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Catalog_modelId_feature", "_UI_Catalog_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				GrapadetoPackage.Literals.CATALOG__MODEL_ID, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GrapadetoPackage.Literals.CATALOG__PATTERNS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case GrapadetoPackage.CATALOG__MODEL_ID:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case GrapadetoPackage.CATALOG__PATTERNS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(GrapadetoPackage.Literals.CATALOG__PATTERNS,
				GrapadetoFactory.eINSTANCE.createPattern()));
	}
