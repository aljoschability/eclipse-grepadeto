 ...
 * @generated
 */
public class NodeItemProvider extends FragmentedItemProvider {
	/**
	...
	protected void addModifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_Node_modifier_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Node_modifier_feature", "_UI_Node_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				GrapadetoPackage.Literals.NODE__MODIFIER, true, false, false,
	...
	protected void addOutgoingsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Node_outgoings_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Node_outgoings_feature", "_UI_Node_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				GrapadetoPackage.Literals.NODE__OUTGOINGS, true, false, true, null, null, null));
	}
	...
	protected void addIncomingsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Node_incomings_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Node_incomings_feature", "_UI_Node_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				GrapadetoPackage.Literals.NODE__INCOMINGS, true, false, true, null, null, null));
	}
