...
/**
 * This is the item provider adapter for a {@link com.aljoschability.eclipse.grapadeto.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkItemProvider extends ConnectionItemProvider {
	...
	protected void addPatternPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Link_pattern_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Link_pattern_feature", "_UI_Link_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				GrapadetoPackage.Literals.LINK__PATTERN, true, false, true, null, null, null));
	}
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				GrapadetoPackage.Literals.LINK__TYPE, true, false, true, null, null, null));
	}
