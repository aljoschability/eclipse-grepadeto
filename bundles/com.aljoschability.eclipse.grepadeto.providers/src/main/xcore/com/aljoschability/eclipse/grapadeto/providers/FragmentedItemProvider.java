 ...
 * @generated
 */
public class FragmentedItemProvider
  extends WeightedItemProvider
  implements
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Fragmented_parents_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Fragmented_parents_feature", "_UI_Fragmented_type"),
         GrapadetoPackage.Literals.FRAGMENTED__PARENTS,
         true,
         false,
         true,
         null,
  ...
  public String getText(Object object)
  {
    ...
    return label == null || label.length() == 0 ?
      getString("_UI_Fragmented_type") :
      getString("_UI_Fragmented_type") + " " + label;
  }
