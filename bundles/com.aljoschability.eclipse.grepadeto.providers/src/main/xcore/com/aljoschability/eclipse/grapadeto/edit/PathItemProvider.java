...
/**
 * This is the item provider adapter for a {@link com.aljoschability.eclipse.grapadeto.Path} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PathItemProvider extends ConnectionItemProvider {
	...
	protected void addPatternPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Path_pattern_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Path_pattern_feature", "_UI_Path_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				GrapadetoPackage.Literals.PATH__PATTERN, true, false, true, null, null, null));
	}
