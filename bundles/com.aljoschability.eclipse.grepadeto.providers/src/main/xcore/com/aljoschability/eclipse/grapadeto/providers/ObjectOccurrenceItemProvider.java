 ...
 * @generated
 */
public class ObjectOccurrenceItemProvider
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_ObjectOccurrence_pattern_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_ObjectOccurrence_pattern_feature", "_UI_ObjectOccurrence_type"),
         GrapadetoPackage.Literals.OBJECT_OCCURRENCE__PATTERN,
         true,
         false,
         true,
         null,
  ...
  protected void addFragmentsPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_ObjectOccurrence_fragments_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_ObjectOccurrence_fragments_feature", "_UI_ObjectOccurrence_type"),
         GrapadetoPackage.Literals.OBJECT_OCCURRENCE__FRAGMENTS,
         true,
         false,
         true,
         null,
  ...
  protected void addTypePropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_ObjectOccurrence_type_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_ObjectOccurrence_type_feature", "_UI_ObjectOccurrence_type"),
         GrapadetoPackage.Literals.OBJECT_OCCURRENCE__TYPE,
         true,
         false,
         true,
         null,
  ...
  public String getText(Object object)
  {
    ...
    return label == null || label.length() == 0 ?
      getString("_UI_ObjectOccurrence_type") :
      getString("_UI_ObjectOccurrence_type") + " " + label;
  }
