...
public class AttributeConstraintItemProvider
  extends BooleanConstraintItemProvider
  implements
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_AttributeConstraint_attribute_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_AttributeConstraint_attribute_feature", "_UI_AttributeConstraint_type"),
         GrapadetoPackage.Literals.ATTRIBUTE_CONSTRAINT__ATTRIBUTE,
         true,
         false,
         true,
         null,
