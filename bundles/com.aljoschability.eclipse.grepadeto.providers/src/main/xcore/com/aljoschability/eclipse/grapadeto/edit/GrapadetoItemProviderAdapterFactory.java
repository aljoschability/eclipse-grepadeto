 ...
 * @generated
 */
public class GrapadetoItemProviderAdapterFactory extends GrapadetoAdapterFactory implements ComposeableAdapterFactory,
	...
	public void dispose() {
		if (booleanConstraintItemProvider != null)
			booleanConstraintItemProvider.dispose();
		if (catalogItemProvider != null)
			catalogItemProvider.dispose();
		if (patternItemProvider != null)
			patternItemProvider.dispose();
		if (constraintExpressionItemProvider != null)
			constraintExpressionItemProvider.dispose();
		if (linkItemProvider != null)
			linkItemProvider.dispose();
		if (attributeConstraintItemProvider != null)
			attributeConstraintItemProvider.dispose();
		if (pathItemProvider != null)
			pathItemProvider.dispose();
		if (fragmentItemProvider != null)
			fragmentItemProvider.dispose();
		if (patternOccurrenceItemProvider != null)
			patternOccurrenceItemProvider.dispose();
		if (objectOccurrenceItemProvider != null)
