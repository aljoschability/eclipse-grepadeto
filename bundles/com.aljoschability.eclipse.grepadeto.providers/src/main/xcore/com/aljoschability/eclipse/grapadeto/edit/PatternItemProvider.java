 ...
 * @generated
 */
public class PatternItemProvider extends CommentableItemProvider {
	/**
	...
	protected void addAbstractPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_Pattern_abstract_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Pattern_abstract_feature", "_UI_Pattern_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				GrapadetoPackage.Literals.PATTERN__ABSTRACT, true, false, false,
	...
	protected void addCatalogPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Pattern_catalog_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Pattern_catalog_feature", "_UI_Pattern_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				GrapadetoPackage.Literals.PATTERN__CATALOG, true, false, true, null, null, null));
	}
	...
	protected void addTypeIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_Pattern_typeId_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Pattern_typeId_feature", "_UI_Pattern_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				GrapadetoPackage.Literals.PATTERN__TYPE_ID, true, false, false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(GrapadetoPackage.Literals.PATTERN__PATTERNS,
				GrapadetoFactory.eINSTANCE.createPatternOccurrence()));

		newChildDescriptors.add(createChildParameter(GrapadetoPackage.Literals.PATTERN__OBJECTS,
				GrapadetoFactory.eINSTANCE.createObjectOccurrence()));

		newChildDescriptors.add(createChildParameter(GrapadetoPackage.Literals.PATTERN__FRAGMENTS,
				GrapadetoFactory.eINSTANCE.createFragment()));

		newChildDescriptors.add(createChildParameter(GrapadetoPackage.Literals.PATTERN__CONSTRAINTS,
				GrapadetoFactory.eINSTANCE.createConstraintExpression()));

		newChildDescriptors.add(createChildParameter(GrapadetoPackage.Literals.PATTERN__LINKS,
				GrapadetoFactory.eINSTANCE.createLink()));

		newChildDescriptors.add(createChildParameter(GrapadetoPackage.Literals.PATTERN__PATHS,
