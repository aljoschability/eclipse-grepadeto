...
/**
 * This is the item provider adapter for a {@link com.aljoschability.eclipse.grapadeto.ConstraintExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintExpressionItemProvider extends FragmentedItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((ConstraintExpression) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_ConstraintExpression_type") : //$NON-NLS-1$
				getString("_UI_ConstraintExpression_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
